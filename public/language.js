(() => {
  const translations = {
    ...
    'A képernyő előtt a kéz volt az első eszközöm – és ma is az maradt. A gyöngyszövésben és a tojásdíszítésben nincs gyorsítás és nincs visszavonás: gyöngyszemenként, viaszcseppenként születik a forma, és minden mozdulat számít. Apró elemekből lesz egész, viaszból és színből pedig olyan minta, amelyet nemzedékek adtak kézről kézre, mielőtt hozzám ért. Ezek a munkák tanítottak meg arra, amit ma minden felületre magammal viszek: hogy minden vonás döntés, és hogy a legszebb formák a legtürelmesebb kezek alatt születnek.': 'Before the screen, my hands were my first tool – and they still are. In bead weaving and egg decorating there is no rushing and no undo: the form is born bead by bead, drop of wax by drop of wax, and every movement counts. Small elements become a whole, and wax and colour become a pattern that generations passed from hand to hand before it reached me. These works taught me what I now carry into every surface I design: that every stroke is a decision, and that the most beautiful forms are born under the most patient hands.',
    ...
    'Közösségi média posztok és hirdetési képek, amelyek megállítják a görgetést – a márkád stílusában.': 'Social media posts and ad visuals that stop the scroll – in your brand’s style.',
    'Logó, színvilág és tipográfia, hogy a márkád első ránézésre felismerhető legyen.': 'Logo, colour palette and typography that make your brand recognisable at first glance.',
    'Weboldalak és alkalmazások felülete, amelyet könnyű és jó érzés használni.': 'Website and app interfaces that are easy and pleasant to use.',
    'Egyedi kézműves darabok': 'Handmade pieces to order',
    'Gyöngyszövött ékszer vagy viaszos technikával díszített tojás – egyedi kérésre, ajándékba is.': 'Bead-woven jewellery or wax-resist decorated eggs – made to order, perfect as gifts too.',
    'Kérj ajánlatot': 'Request a quote',
    'Koncepció és': 'Concepts and', 'AI-kísérletek': 'AI experiments',
    'Digitális munkák · Illusztráció': 'Digital work · Illustration',
    'Digitális festészet': 'Digital painting',
    'Sorozatok': 'Series',
    'Képek, amelyek történetet mesélnek. A digitális illusztrációimban a klasszikus festészet textúrái és színei találkoznak a modern eszközökkel: nagy formák, apró alakok, csend és feszültség. Minden sorozat egy gondolat körül forog, és minden kép egy újabb nézőpont ugyanarra a kérdésre.': 'Images that tell stories. In my digital illustrations the textures and colours of classical painting meet modern tools: large forms, tiny figures, silence and tension. Each series revolves around one thought, and every image is a new point of view on the same question.',
    'Szikszai Zsu digitális illusztrációi.': 'Digital illustrations by Szikszai Zsu.',
    'Digitális munkák · Koncepció': 'Digital work · Concept',
    'Ötletelés': 'Ideation',
    'Prompttervezés': 'Prompt design',
    'Kísérletek': 'Experiments',
    'Itt a folyamat a főszereplő: hogyan lesz egy gondolatból kép. Vázlatok, hangulatképek, változatok és kísérletek – az ötlettől a promptig, és a prompttól a kész vizuálig. A mesterséges intelligencia nálam eszköz, a döntéseket a szemem hozza meg.': 'Here the process takes centre stage: how a thought becomes an image. Sketches, mood boards, variations and experiments – from idea to prompt, and from prompt to finished visual. For me, artificial intelligence is a tool; my eye makes the decisions.',
    'Szikszai Zsu koncepciói és AI-kísérletei.': 'Concepts and AI experiments by Szikszai Zsu.',
    'Digitális munkák · Arculat': 'Digital work · Brand identity',
    'Logó': 'Logo',
    'Arculat': 'Brand identity',
    'Egy márka akkor erős, ha első ránézésre felismerhető. Logókat, színvilágot, tipográfiát és kampányvizuálokat tervezek, amelyek egységes, karakteres képet adnak – a névjegytől a közösségimédia-posztig.': 'A brand is strong when it is recognisable at first glance. I design logos, colour palettes, typography and campaign visuals that create a consistent, distinctive image – from the business card to the social media post.',
    'Szikszai Zsu grafikai és arculati munkái.': 'Graphic design and brand identity work by Szikszai Zsu.',
    '„Az élet ott kezdődik, ahol a komfortzónád véget ér.”': '“Life begins where your comfort zone ends.”',
    'Ez az oldal Szikszai Zsu személyes portfóliója. Röviden és érthetően leírom, milyen adatokat kezel az oldal, miért, és milyen jogaid vannak.': 'This site is Szikszai Zsu’s personal portfolio. Here I explain, briefly and clearly, what data the site handles, why, and what your rights are.',
    'Ki kezeli az adatokat?': 'Who handles the data?',
    'Az adatkezelő Szikszai Zsu. Adatvédelmi kérdéseiddel a szikszaizsu86@gmail.com címen kereshetsz.': 'The data controller is Szikszai Zsu. You can reach me with privacy questions at szikszaizsu86@gmail.com.',
    'Kapcsolatfelvételi űrlap': 'Contact form',
    'Ha üzenetet küldesz, a megadott neved, e-mail-címed és üzeneted a FormSubmit (formsubmit.co) külső szolgáltatón keresztül e-mailben jut el hozzám. Ezeket az adatokat kizárólag arra használom, hogy válaszoljak neked: nem adom tovább, és nem küldök hírlevelet. Addig őrzöm meg őket, amíg a kapcsolattartáshoz szükséges, kérésedre pedig törlöm őket.': 'If you send a message, the name, email address and message you enter reach me by email through FormSubmit (formsubmit.co), an external service. I use this data only to reply to you: I do not share it and I do not send newsletters. I keep it only as long as needed for our correspondence, and I delete it on request.',
    'Látogatásszámláló': 'Visit counter',
    'Az oldal egy egyszerű számlálóval méri, hányszor látogatták meg. Ehhez egy 30 percig érvényes sütit (portfolio_visit) használ, amely nem tartalmaz személyes adatot, csak azt jelzi, hogy az adott látogatást már megszámolta. Nem használok elemző, követő vagy hirdetési sütiket.': 'The site counts its visits with a simple counter. To do this it uses a cookie (portfolio_visit) that lasts 30 minutes and contains no personal data; it only marks that the current visit has already been counted. I do not use analytics, tracking or advertising cookies.',
    'A böngésződben tárolt beállítások': 'Settings stored in your browser',
    'A választott nyelvet a böngésződ helyi tárolója (localStorage) jegyzi meg, hogy legközelebb is azon a nyelven lásd az oldalt. Ez az adat a saját eszközödön marad, nem jut el hozzám.': 'Your chosen language is remembered in your browser’s local storage (localStorage), so you see the site in the same language next time. This stays on your own device and never reaches me.',
    'Tárhely': 'Hosting',
    'Az oldal a Cloudflare szerverein fut. A Cloudflare a működéshez és a biztonsághoz technikai adatokat, például IP-címet naplózhat. A betűtípusok és a képek az oldal saját tárhelyéről töltődnek be, így külső szolgáltatóhoz nem jut adat. A Facebook- és Instagram-linkek csak akkor visznek át ezekre az oldalakra, ha rájuk kattintasz.': 'The site runs on Cloudflare’s servers. Cloudflare may log technical data such as IP addresses for operation and security. Fonts and images load from the site’s own hosting, so no data goes to other providers. The Facebook and Instagram links only take you to those sites if you click them.',
    'A jogaid': 'Your rights',
    'Kérheted a rólad tárolt adatokhoz való hozzáférést, azok helyesbítését vagy törlését, és tiltakozhatsz a kezelésük ellen. Ha úgy érzed, hogy megsértettem a jogaidat, panaszt tehetsz az adatvédelmi hatóságnál (Romániában: ANSPDCP, Magyarországon: NAIH).': 'You can ask for access to the data stored about you, have it corrected or deleted, and object to its processing. If you feel your rights have been violated, you can complain to the data protection authority (in Romania: ANSPDCP, in Hungary: NAIH).',
    'Utolsó frissítés: 2026. szeptember 23.': 'Last updated: 23 September 2026',
    'Adatvédelem': 'Privacy',
    'Adatvédelmi tájékoztató': 'Privacy notice',
    'Szikszai Zsu portfóliójának adatvédelmi tájékoztatója.': 'Privacy notice for Szikszai Zsu’s portfolio.',
    'Az élet ott kezdődik, ahol a komfortzónád véget ér.': 'Life begins where your comfort zone ends.',
    ...
    'Ötlettől a promptig': 'From idea to prompt',
    'Grafika és arculat': 'Graphics and brand identity',
    'Vizuális identitások': 'Visual identities',
    'Webdesign és digitális felületek': 'Web design and digital interfaces',
    'Élmények a képernyőn': 'Experiences on screen',
    'Virágokkal körülölelt kezek digitális illusztrációja': 'Digital illustration of hands surrounded by flowers',
    'Piros, fekete és fehér gyöngykarkötő': 'Red, black and white beaded bracelet',
    'Fekete és lila mintás gyöngykarkötő': 'Beaded bracelet with a black and purple pattern',
    'Fekete és piros mintás gyöngykarkötő': 'Beaded bracelet with a black and red pattern',
    'Piros és fekete mintás gyöngykarkötő': 'Beaded bracelet with a red and black pattern',
    'Fekete és áttetsző mintás gyöngykarkötő': 'Beaded bracelet with a black and clear pattern',
    '← Vissza a hagyományos technikákhoz': '← Back to traditional techniques',
    '← Vissza a digitális kategóriákhoz': '← Back to digital categories',
    'UX/UI tervezés': 'UX/UI design',
    ...
    'Ez nem gyors munka: a viasz felvitele ugyanolyan türelmet igényel, mint a gyöngyszövés – sorról sorra, formáról formára. Az eredmény törékeny, mégis tartós: egy tárgy, amely magában hordozza azt a csendet és figyelmet, amelyből született.': 'This is not quick work: applying the wax takes the same patience as bead weaving – row by row, shape by shape. The result is fragile, yet lasting: an object that carries within it the silence and attention it was born from.',
