(() => {
  const translations = {
    ...
    'Kézből képernyőre': 'From hand to screen', 'Amiben segítek': 'How I can help', 'Ahogy dolgozom': 'How I work',
    'Kézzel kezdtem: gyöngyöt szőttem, tojást írtam, nemezeltem. Ma digitális alkotóként és UX/UI tervezőként dolgozom, de a módszerem ugyanaz maradt: türelem, figyelem a részletekre, és az, hogy minden munkának legyen lelke. Az MI nálam nem helyettesíti a kezet, csak gyorsabbá teszi.': 'I started with my hands: weaving beads, decorating eggs with wax, felting. Today I work as a digital creator and UX/UI designer, but my method hasn’t changed: patience, attention to detail, and making sure every piece has a soul. For me, AI doesn’t replace the hand, it just makes it faster.',
    'Hirdetéseket és kampányvizuálokat tervezek, amelyek megállítják a görgetést, márkaképeket, amelyekre emlékeznek, és felületeket, amelyeket könnyű használni. Az ötlettől a kész anyagig egy kézben tartom a folyamatot, így az eredmény egységes, és a te hangodon szól.': 'I design ads and campaign visuals that stop the scroll, brand imagery people remember, and interfaces that are easy to use. I keep the whole process in one pair of hands, from idea to finished material, so the result is consistent and speaks in your voice.',
    'Először megértem, mit szeretnél elmondani és kinek, csak utána keresem hozzá a formát. Hiszek az egyszerűségben, ami mögött sok munka van: kevés szó, erős kép, tiszta döntések. Bármilyen eszközzel dolgozom, legbelül mindig művész maradok.': 'First I understand what you want to say and to whom; only then do I look for the form. I believe in simplicity with a lot of work behind it: few words, strong images, clear decisions. Whatever tools I use, I remain an artist at heart.',
